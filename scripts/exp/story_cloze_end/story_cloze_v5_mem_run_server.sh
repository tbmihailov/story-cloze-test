...
for ((i=6;i<END;i++)); do
    ...
    for ((run_id_it=0;run_id_it<num_runs;run_id_it++)); do
        for ((run_id=0;run_id<1;run_id++)); do
            for ((run_hs=0;run_hs<8;run_hs++)); do
                run_name=story_cloze_v5_mem_emb${loop_emb_name}
        ...
        #        dev_data_submission_name="roc_random_spring2016"
                ...
                lstm_layers=${memnet_hops[$run_hs]}  # 6
                ...
                run_name=${run_name}_run${run_id_it}
